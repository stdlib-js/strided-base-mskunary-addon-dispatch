...
```javascript
dispatch = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/strided-base-mskunary-addon-dispatch@v0.2.0-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/strided-base-mskunary-addon-dispatch/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/strided-base-mskunary-addon-dispatch/actions/workflows/test.yml?query=branch:v0.2.0
